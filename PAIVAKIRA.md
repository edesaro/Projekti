...
## 24.3.2026 Tehtävät 2 & 3 – Robot Framework GUI-testaus
...
### Komennot joilla testit ajettiin
```bash
...
## 5.4.2026 Tehtävät 4, 5 ja 6 – Lisätestaukset
...
## 3.5.2026 Tehtävä 7 – Testiraporttien ohjaus outputs-kansioon

**Status:** ✅ Valmis

**Tehty:**
- Kaikki testien loki- ja raporttitiedostot ohjattu erilliseen `outputs/`-kansioon
- Käytetty `--outputdir` lippua Robot Framework -komennoissa
...
## 3.5.2026 Tehtävä 9 – Taustapalvelimen testaus (API-testit)

**Status:** ✅ Valmis

**Tehty:**
- Asennettu `robotframework-requests` -kirjasto API-testausta varten
- Kirjoitettu Robot Framework -testi joka testaa backendin REST API -reittejä
- Testattu `POST /users/login` oikeilla ja väärillä tunnuksilla
- Tiedosto: `testit/teht9.robot`
...
**Testitiedosto `testit/teht9.robot`:**
```robot
*** Settings ***
...
**Komennot:**
```bash
node Projekti/backend/server.js
python -m robot --outputdir outputs/teht9 Projekti/testit/teht9.robot
```

**Huomiot:**
- Backend täytyy olla käynnissä ennen testien ajoa
- PowerShellissä `&&` ei toimi — aja komennot erikseen tai käytä `;`
- `requests`-kirjasto ja `robotframework-requests` ovat eri paketteja — molemmat tarvitaan

**Tulokset:** Molemmat testitapaukset läpäisty. Raportti: `outputs/teht9/report.html`

---

## 3.5.2026 Tehtävä 10 – Dokumentointi Markdownilla

**Status:** ✅ Valmis

**Tehty:**
- Kaikki tehdyt tehtävät dokumentoitu tähän `PAIVAKIRA.md`-tiedostoon
- Dokumentti sisältää jokaisesta tehtävästä: mitä tehtiin, käytetyt komennot, tulokset ja huomiot
- Tiedosto tallennettu projektin GitHub-kansioon

---

## Testiraportit

| Tehtävä | Raportti | Loki |
|---------|----------|------|
| Tehtävä 4 | [report.html](outputs/teht4/report.html) | [log.html](outputs/teht4/log.html) |
| Tehtävä 5 | [report.html](outputs/teht5/report.html) | [log.html](outputs/teht5/log.html) |
| Tehtävä 6 | [report.html](outputs/teht6/report.html) | [log.html](outputs/teht6/log.html) |
| Tehtävä 9 | [report.html](outputs/teht9/report.html) | [log.html](outputs/teht9/log.html) |